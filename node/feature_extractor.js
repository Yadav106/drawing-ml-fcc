...
const featureFunctions = require("../common/featureFuntions.js");
...
fs.writeFileSync(constants.TRAINING_CSV, 
  utils.toCSV([...featureNames, "Label"], training.map(a => [...a.point, a.label]))
);

fs.writeFileSync(constants.TESTING_CSV, 
  utils.toCSV([...featureNames, "Label"], testing.map(a => [...a.point, a.label]))
);
